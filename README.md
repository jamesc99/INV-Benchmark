...
Description:
Run cuteSV2 on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners
Datatype: Data type for sequencer-specific parameter ('pacbio' or 'ont')

Outputs:
inv_cutesv2_${outputname}.vcf: Inversion calls made by cuteSV2
```

**severus_default.sh**

Description:
Run Severus on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
inv_severus.vcf: Inversion calls made by Severus
```

**sniffles2.7_benchmark.sh**

Description:
Run Sniffles2 on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
inv_sniffle2_${name}.vcf: Inversion calls made by Sniffles2
```

**svim_alignment.sh**

Description:
Run SVIM on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
filtered_qual_10_inv.vcf: Inversion calls made by SVIM (after filtering out QUAL<10)
```

**svision-pro_germline.sh**

Description:
Run SVision-pro on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
inv_only_add_simplesv.sorted.vcf: Inversion calls made by SVision-pro
```

**gridss2_germline_sr.sh**

Description:
Run GRIDSS2 on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
simple_inv.vcf: Inversion calls made by GRIDSS2
```

**manta_germline_shortread.sh**

Description:
Run Manta on alignment BAM file to generate INV calls.
```
Inputs:
Alignment_BAM: Paht of aligment BAM file generated by aligners

Outputs:
inv_with_infor.vcf: Inversion calls made by Manta
```
